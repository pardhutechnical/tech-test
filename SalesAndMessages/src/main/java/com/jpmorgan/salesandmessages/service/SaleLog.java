package com.jpmorgan.salesandmessages.service;
...
public class SaleLog {
	...
	public void report() {
		...
		if ((normalReports.size() % 50) == 0 && normalReports.size() != 0) {
			System.out.println(
					"Application is pausing now as it reached 50 maximum messages it will not accept new messages. The following are the adjustment records made to each sale;\n");
